	...
	$settings[20] = array(
		...
		'desc'	=> __( 'Select the theme locations to activate automatically.  Works with most modularly coded themes.  The above theme locations are specific to your site.' , 'ubermenu' ) .
					'<div class="ubermenu-alert">'.
						'<strong>Are things not looking right after Automatic Integration?</strong>'.
						'<p>You may have interference from the theme.  Please visit the '.
						'<a target="_blank" href="https://sevenspark.com/docs/ubermenu-3/integration/fix-interference">Resolving Theme Interference Guide</a> '.
