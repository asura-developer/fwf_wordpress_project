...
== Upgrade Notice ==
* 0.8.14 : * Fix currently shown menu is not closed when a new tab is selected. Fix missing sites after editing site description and clicking choose another site to manage button. Fix computed cached key retrieval error. Call action updraftcentral_version_updated upon update. Load sites information from background process.
