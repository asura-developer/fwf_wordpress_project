...
class UpdraftCentral_User {
	...
	public function __construct($user_id) {
		...
		add_filter('updraftcentral_dashboard_ajaxaction_get_sites_information', array($this, 'dashboard_ajaxaction_get_sites_information'), 10, 2);
	 ...
	 * @return array
	 */
	public function dashboard_ajaxaction_get_sites_information($response, $post_data) {
