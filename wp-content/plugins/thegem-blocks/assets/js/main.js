(function ($) {
    ...
    function TheGemBlocks(options) {
        ...
        this.$panelContainer = $('.vc_ui-panel-content-container');
    ...
    TheGemBlocks.prototype = {
        ...
        hide: function() {
            ...
            if (this.$panelContainer.hasClass('thegem-blocks-panel-container')) {
                this.$panelContainer.removeClass('thegem-blocks-panel-container');
            }
        ...
        setActiveTab: function() {
            ...
            if (this.activeTabName === this.options.tab_name) {
                this.$panelContainer.addClass('thegem-blocks-panel-container');
            }
        ...
        filterItems: function() {
            ...
            if (['all', 'favorite'].indexOf(self.activeCategory) === -1) {
                self.$items = self.$templates.filter(function(idx, item) {
                    return $(item).data('category') === self.activeCategory;
                });
            }
        ...
        initGrid: function () {
            ...
            imagesLoaded($grid, function() {
                self.$templatesScrollContainer.find('.'+self.spinnerClassName).fadeOut(300, function () {
                    this.remove();
