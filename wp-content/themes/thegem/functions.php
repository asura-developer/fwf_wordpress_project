...
function thegem_admin_scripts_init() {
	...
	wp_enqueue_style('thegem-admin-styles', get_template_directory_uri() . '/css/thegem-admin.css', array(), '4.5.0');
	...
	wp_enqueue_script('thegem-admin-functions', get_template_directory_uri() . '/js/thegem-admin_functions.js', array('jquery'), '4.5.0');
...
if(!function_exists('thegem_page_title')) {
	function thegem_page_title() {
		...
		if (is_singular() || is_tax() || is_category() || is_tag() || is_search() || is_archive() || is_post_type_archive('product') || is_tax('product_cat') || is_tax('product_tag') || (is_404() && get_post(thegem_get_option('404_page')))) {
			...
			$parallax_bg = (!empty($page_data['title_background_parallax']) && $page_data['title_background_parallax']) || $page_data['title_background_effect'] == 'parallax';
			...
			if ($page_data['title_background_image']) {
				...
				} else if ($ken_burns_bg) {
				    $ken_burns_style = 'background-image: url(' . $page_data['title_background_image'] . ');';
		...
		if($title_style == 2 && !empty($page_data['title_template']) && get_post($page_data['title_template']) && !(defined('WPB_VC_VERSION') && (vc_is_frontend_editor() || vc_is_page_editable()))) {
			...
			return '<div id="page-title" class="page-title-block page-title-alignment-' . esc_attr($alignment) . ' page-title-style-' . esc_attr($title_style) . ' ' . esc_attr(implode(' ', $title_classes)) . ($parallax_bg ? ' page-title-parallax-background-wrap' : '') . '" style="' . esc_attr($css_style) . '">
