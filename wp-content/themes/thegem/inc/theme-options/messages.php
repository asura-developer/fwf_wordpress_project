...
return array(
    ...
    'info' => array (
        ...
        'title_area_type_of_title_area' => __('<p><b>Regular Title:</b> you can setup the layout & style of title area using the settings below.</p><p><b>Custom Title:</b> you can select to use some pre-made custom title for your title area.</p>', 'thegem'),
        ...
        'footer_custom_footer'  => __('In addition (or instead of) footer widget area and bottom area you can also use some pre-made custom footer for your post/page footer area.', 'thegem'),
        'footer_select_custom_footer'  => __('Select pre-made custom footers from the list.', 'thegem'),
        ...
        'single_pages_post_type_of_title_area' => __('<p><b>Regular Title:</b> you can setup the layout & style of title area using the settings below.</p><p><b>Custom Title:</b> you can select to use some pre-made custom title for your title area.</p>', 'thegem'),
        ...
        'single_pages_post_select_custom_footer' => __('Select pre-made custom footers from the list.', 'thegem'),
        ...
        'single_pages_page_select_custom_footer' => __('Select pre-made custom footers from the list.', 'thegem'),
        ...
        'single_pages_portfolio_type_of_title_area' => __('<p><b>Regular Title:</b> you can setup the layout & style of title area using the settings below.</p><p><b>Custom Title:</b> you can select to use some pre-made custom title for your title area.</p>', 'thegem'),
        ...
        'single_pages_portfolio_select_custom_footer' => __('Select pre-made custom footers from the list.', 'thegem'),
        ...
        'archive_pages_blog_type_of_title_area' => __('<p><b>Regular Title:</b> you can setup the layout & style of title area using the settings below.</p><p><b>Custom Title:</b> you can select to use some pre-made custom title for your title area.</p>', 'thegem'),
        ...
        'archive_pages_blog_select_custom_footer' => __('Select pre-made custom footers from the list.', 'thegem'),
        ...
        'archive_pages_search_type_of_title_area' => __('<p><b>Regular Title:</b> you can setup the layout & style of title area using the settings below.</p><p><b>Custom Title:</b> you can select to use some pre-made custom title for your title area.</p>', 'thegem'),
        ...
        'archive_pages_search_select_custom_footer' => __('Select pre-made custom footers from the list.', 'thegem'),
        ...
        'woocommerce_product_page_apply_on_all_existing' => __('By default, global settings will be applied on all new product pages. Optionally you can apply global settings set below automatically to all existing product pages as well by clicking on the button "Apply Now". Please note: by doing this, current settings in the existing product pages will be replaced by global settings set below.', 'thegem'),
        ...
        'woocommerce_product_page_title_area' => __('Title area includes title, excerpt and breadcrumbs. Here you can enable or disable title area for product page.', 'thegem'),
        'woocommerce_product_page_type_of_title_area' => __('<p><b>Regular Title:</b> you can setup the layout & style of title area using the settings below.</p><p><b>Custom Title:</b> you can select to use some pre-made custom title for your title area.</p>', 'thegem'),
        ...
        'woocommerce_product_page_select_custom_footer' => __('Select pre-made custom footers from the list.', 'thegem'),
        ...
        'woocommerce_product_categories_title_area' => __('Title area includes title, excerpt and breadcrumbs. Here you can enable or disable title area for product categories.', 'thegem'),
        'woocommerce_product_categories_type_of_title_area' => __('<p><b>Regular Title:</b> you can setup the layout & style of title area using the settings below.</p><p><b>Custom Title:</b> you can select to use some pre-made custom title for your title area.</p>', 'thegem'),
        ...
        'woocommerce_product_categories_select_custom_footer' => __('Select pre-made custom footers from the list.', 'thegem'),
        ...
        'p_options_title_area_general_type_title_area' => __('<p><b>Regular Title:</b> you can setup the layout & style of title area using the settings below.</p><p><b>Custom Title:</b> you can select to use some pre-made custom title for your title area.</p>', 'thegem'),
        ...
        'p_options_footer_custom_footer' => __('In addition (or instead of) footer widget area and bottom area you can also use some pre-made custom footer for your post/page footer area. Select "Default Setting" to inherit this setting from theme options.', 'thegem'),
        'p_options_footer_select_custom_footer' => __('Select pre-made custom footers from the list.', 'thegem'),
    ...
    'general' => array(
        ...
        'custom_title' => __('Custom Title', 'thegem'),
    ...
    'menu' => array(
        ...
        'woocommerce_product-styles' => __('Product Styles', 'thegem'),
    ...
    'panel' => array(
        ...
        'custom_footer' => __('Custom Footer', 'thegem'),
        'custom_footer_select' => __('Select Custom Footer', 'thegem'),
        'font' => __('Font', 'thegem'),
        ...
        'font_light' => __('Light Title Font', 'thegem'),
        ...
        'default_font_light' => __('Light Title Font Defaults', 'thegem'),
        ...
        'checkout_layout' => __('Checkout Layout', 'thegem'),
    ...
    'settings' => array(
        ...
        'highlighted_product' => __('Highlight This Product in Extended Grid', 'thegem'),
        'video_type' => __('Video Type', 'thegem'),
        'aspect_ratio' => __('Aspect Ratio', 'thegem'),
        'gallery_autoscroll' => __('Autoscroll (msec)', 'thegem'),
        'custom_title' => __('Select Custom Title', 'thegem'),
    ...
    'colors' => array(
        ...
        'page_number_text_active' => __('Active Page Number Text Color', 'thegem'),
    ...
    'alert' => array(
        ...
        'create_custom_title' => __('To create new custom title go to', 'thegem'),
        'create_custom_title_link' => __('Custom Titles -> Add New', 'thegem'),
        'create_custom_footer' => __('To create new custom footer go to', 'thegem'),
        'create_custom_footer_link' => __('Custom Footers -> Add New', 'thegem'),
