...
<fieldset class="hidden-by-title-style-none hidden-by-title-style-template show-by-title-template-custom">
	...
	<table class="settings-box-table" width="100%"><tbody><tr>
		<td>
            ...
            <br>
            <br>
            <label for="page_title_background_effect"><?php esc_html_e('Background effect', 'thegem'); ?>:</label><br>
            <?php thegem_print_select_input(thegem_get_page_title_background_effect_list(), esc_attr($page_data['title_background_effect']), 'thegem_page_data[title_background_effect]', 'page_title_background_effect'); ?>

            <div class="page-title-background-ken-burns-options-box" style="display: <?= $page_data['title_background_effect']=='ken_burns' ? 'block' : 'none' ?>">
                <br>
                <label for="page_title_background_ken_burns_direction"><?php esc_html_e('Direction', 'thegem'); ?>:</label><br />
                <?php thegem_print_select_input(thegem_get_page_title_background_ken_burns_direction_list(), esc_attr($page_data['title_background_ken_burns_direction']), 'thegem_page_data[title_background_ken_burns_direction]', 'page_title_background_ken_burns_direction'); ?>
                <br>
                <br>
                <label for="page_title_background_ken_burns_transition_speed"><?php esc_html_e('Transition speed, ms', 'thegem'); ?>:</label><br />
                <input name="thegem_page_data[title_background_ken_burns_transition_speed]" id="page_title_background_ken_burns_transition_speed" value="<?php echo esc_attr($page_data['title_background_ken_burns_transition_speed']); ?>" type="text" /><br />
            </div>
...
(function($) {
	$(function() {
		...
		$('#page_title_background_effect').change(function() {
		    if ($(this).val() == 'ken_burns') {
		        $('.page-title-background-ken-burns-options-box').show();
            } else {
                $('.page-title-background-ken-burns-options-box').hide();
            }
        });
	});
})(jQuery);
...
function thegem_get_sanitize_page_title_data($post_id = 0, $item_data = array(), $type = false) {
	...
	if (!empty($page_data['title_background_parallax']) && $page_data['title_background_parallax']) {
        $page_data['title_background_effect'] = 'parallax';
    }
    ...
    $page_data['title_background_ken_burns_transition_speed'] = $page_data['title_background_ken_burns_transition_speed'] ? sanitize_text_field($page_data['title_background_ken_burns_transition_speed']) : 15000;
